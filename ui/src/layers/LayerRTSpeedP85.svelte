<script lang="ts">
    ...
    function getSpeedStyle(wayId: string): L.PathOptions {
        ...
        const speed_p85 = props?.speed_p85;
        ...
        if (
            speed_p85 !== undefined &&
            speed_p85 !== null &&
            !isNaN(Number(speed_p85))
        ) {
            const speedValue = Number(speed_p85);
    ...
    $effect(() => {
        ...
        const filteredFeatures = geoData.features.filter(
            (feature: Feature | undefined) => {
                ...
                return (
                    props?.speed_p85 !== undefined &&
                    props?.speed_p85 !== null &&
                    !isNaN(Number(props?.speed_p85))
                );
            },
        );
        ...
        const newLayer = L.geoJSON(
            // Order by speed_p85 asc, to plot higher speeds on top
            filteredFeatures.sort((a, b) => {
                ...
                const propsB = b.properties?.way_osm_id
                    ...
                    : null;
                return (propsA?.speed_p85 || 0) - (propsB?.speed_p85 || 0);
            }),
            {
