<script lang="ts">
    ...
    const diagramText = `
erDiagram
    Prioritisation_Area_Polygon_GeoJSON {
        Polygon geometry "Convex hull enclosing all prioritised segments"
    }
    ...
    Metadata_JSON {
        ...
        object prioritisation "Global missing shapes/routes metrics"
        object prioritisation_hour "Hourly lists of missing shapes and routes"
    ...
    Prioritisation_Area_Polygon_GeoJSON ||--o{ Ways_GeoJSON : "spatially encloses"
        ...
        >
            ...
            <section>
                        ...
                        <tbody class="divide-y divide-border/30">
                            ...
                            <tr>
                                <td class="px-4 py-2 font-mono text-foreground"
                                    >prioritisation_area_polygon_...geojson</td
                                >
                                <td class="px-4 py-2 text-muted-foreground"
                                    >Spatial boundary (convex hull) of the
                                    prioritisation analysis.</td
                                >
                            </tr>
                            ...
                            <tr class="bg-muted/10">
                                ...
                                >
                                <td class="px-4 py-2 text-muted-foreground"
                                    >Original GTFS file considered in the
                                    analysis.</td
                                >
                            </tr>
                            <tr class="bg-muted/10">
                                ...
                                >
                                <td class="px-4 py-2 text-muted-foreground"
                                    >GTFS file manipulated with necessary
                                    adjustments and filtered to analysis day.</td
                                >
                            </tr>
                            <tr class="bg-muted/10">
                                <td class="px-4 py-2 font-mono text-foreground"
                                    >prioritisation_...csv</td
                                >
                                <td class="px-4 py-2 text-muted-foreground"
                                    >CSV file with result of <a
                                    ...
                                    and
                                    <a
                                        href="https://u-shift.github.io/GTFShift/reference/rt_extend_prioritisation.html"
                                        target="_blank"
                                        class="bg-muted px-1.5 py-0.5 rounded text-xs font-mono hover:underline"
                                        >GTFShift::rt_extend_prioritisation()</a
                                    >.</td
                                >
                            </tr>
                        </tbody>
                ...
                <p class="text-muted-foreground text-xs mt-3">
                    Some files are available in multiple formats (such as
                    GeoJSON and GPKG or JSON and CSV) to facilitate integration
