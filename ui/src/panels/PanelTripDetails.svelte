...
{#if selectedTripId && selected_shape_id && selected_shape_id !== "all" && geoData}
    ...
    <div
        ...
        class="absolute top-4 left-4 right-4 sm:left-auto lg:right-[404px] sm:right-4 z-[1015] flex flex-col w-[calc(100vw-2rem)] sm:w-[380px] h-fit max-h-[calc(100vh-2rem)] rounded-xl bg-background/95 backdrop-blur shadow-xl border p-5 overflow-y-auto gap-4"
    >
        <!-- Header -->
        <div
        ...
        >
            <div class="space-y-1 min-w-0">
                <div class="flex items-center gap-2">
                    <Button
                        ...
                        class="h-6 px-1.5 text-xs text-muted-foreground hover:text-foreground -ml-1 gap-1"
                ...
                <div class="flex items-center gap-1.5 pt-0.5">
                    <h3
                        class="text-sm font-mono font-bold text-foreground truncate max-w-[240px]"
                    ...
                    <button
                        type="button"
                        class="text-muted-foreground hover:text-foreground text-xs p-1 rounded transition-colors"
                        onclick={() => copyTripId(selectedTripId)}
                        title="Copy Trip ID"
                    >
                        {#if copied}
                            <i class="fas fa-check text-emerald-500 text-[11px]"
                            ></i>
                        {:else}
            ...
            <Button
                ...
                size="icon"
                onclick={() => (selectedTripId = undefined)}
                class="rounded-full shrink-0 h-8 w-8 text-muted-foreground hover:text-foreground"
                ...
                <div class="grid grid-cols-3 gap-2">
                    ...
                    {#if trip.commercial_speed_median != null}
                        ...
                        >
                            ...
                            <p class="text-sm font-bold">
                                {Number(trip.commercial_speed_median).toFixed(
                                    1,
                                )}<span class="text-[9px] font-normal">
                                    km/h</span
                                >
                            ...
                            <div>
                                ...
                                <p class="text-sm font-bold">
                                    {tripDI > 0 ? "+" : ""}{(
                                        ...
                                        class="text-[9px] font-normal">%</span
                                    >
                                </p>
                            </div>
                            {#if tripDICategory}
        ...
        {#if sortedTripDays.length > 0}
            ...
            {@const hasP85 = sortedTripDays.some((d) => d.speed_p85 != null)}
            ...
            >
                ...
                <p class="text-[10px] text-muted-foreground">
                    Observed commercial speed per date for this scheduled trip.
                </p>

                <!-- Daily Bar Chart -->
                <div
                    class="flex items-end gap-[2px] h-28 border-l border-b border-muted-foreground/30 px-1 pt-2 bg-muted/10 rounded-sm relative"
                >
                            ...
                            <tr>
                                ...
                                {#each sortedTripDays as d}
                                    ...
                                    <td
                                        ...
                                        title="{formatDayFull(d.day)} avg speed"
                                    >
            ...
            {#if sortedTripDays.some((d) => d.disturbance_index != null)}
                ...
                >
                    ...
                    <p class="text-[10px] text-muted-foreground">
                        Variation relative to shape baseline (positive: faster,
                        negative: slower).
                    </p>
            ...
            >
                <div class="flex items-center justify-between">
                    <h6
                        class="text-xs font-bold flex items-center gap-1.5 uppercase tracking-wider text-muted-foreground"
                    >
                        <i class="fas fa-table" style="color: {shapeColor}"></i>
                        Daily Breakdown
                    </h6>
        ...
        {:else}
            ...
            >
                ...
                ></i>
                <p class="text-xs font-semibold">No daily variation records</p>
                <p class="text-[10px]">
